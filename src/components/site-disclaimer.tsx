  ...
  return (
    ...
    >
      <p className="mx-auto max-w-3xl">
        While the activities listed here are a useful guide, if you live in an area with poor light, water and magnetism, they may not be effective, and you may need to consider relocating. 

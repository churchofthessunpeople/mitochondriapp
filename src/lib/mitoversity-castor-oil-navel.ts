  ...
  intermediate: {
    sections: [
      ...
      },
      {
        ...
        body: "Up to ~90% of castor oil is ricinoleic acid (12-hydroxy-9-octadecenoic acid): an 18-carbon monounsaturated fatty acid with a hydroxyl (-OH) on carbon 12. That hydroxyl increases polarity and hydrogen-bonding versus plain oleic acid. Pharmacology knows ingested castor oil as a stimulant laxative and topical castor as an occlusive emollient. Lifestyle teaching extends the chemistry story: a polar lipid at the navel may structure nearby interfacial water and shift local tissue electrochemistry more than neutral seed oils—hypothesis tier, not established clinical endpoint.",
      },
      {
      ...
      {
        heading: "How this fits the app",
        body: "Log “Castor oil navel application” on evenings you apply oil. Stack with deuterium-aware meals, hydration timing, and early dinner in the Water pillar. Choose your reading level above for more or less technical depth.",
      },
    ],
  },
  advanced: {
